...
public class MahasiswaAksi {
    public static void main(String[] args) {
        ...
        nilai1.add(3.0);
        nilai1.add(4.0);
        mahasiswaList.add(new Mahasiswa("Maulana", "13837", nilai1));
		 ArrayList<Double> nilai2 = new ArrayList<Double>();
        nilai2.add(3.9);
        nilai2.add(3.0);
        nilai2.add(4.0);
        mahasiswaList.add(new Mahasiswa("Tegar", "A11.13837", nilai2));
        ArrayList<Double> nilai3 = new ArrayList<Double>();
        nilai3.add(3.2);
        nilai3.add(3.0);
        nilai3.add(4.0);
        mahasiswaList.add(new Mahasiswa("Ibrahim", "A11.2021.13837", nilai3));
